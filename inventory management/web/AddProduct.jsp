<%-- 
    Document   : AddProduct
    Created on : Jul 14, 2020, 4:32:25 PM
    Author     : Kamran
--%>
...
<%
    ...
    try
    {
        db.pstmt=db.con.prepareStatement("insert into manageinventory(productname,quantity,measurement,"
                + "originalprice,profit,sellingprice,supplier,inventory) values(?,?,?,?,?,?,?,?)");
